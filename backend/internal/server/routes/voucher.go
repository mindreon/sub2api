...
func RegisterVoucherRoutes(
	...
	adminGroup.Use(gin.HandlerFunc(adminAuth))
	{
		...
		adminGroup.GET("/products", adminVoucherHandler.ListProducts)
		adminGroup.GET("/b2b/orders", adminVoucherHandler.ListB2BOrders)
		adminGroup.POST("/b2b/orders", adminVoucherHandler.CreateB2BOrder)
		adminGroup.GET("/b2b/orders/:id", adminVoucherHandler.GetB2BOrder)
		adminGroup.POST("/b2b/orders/:id/sync", adminVoucherHandler.SyncB2BOrder)
		adminGroup.POST("/b2b/orders/:id/payment-proof", adminVoucherHandler.SubmitB2BProof)
