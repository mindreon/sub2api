...
const (
	// Label holds the string label denoting the voucherauditlog type in the database.
	Label = "voucher_audit_log"
	...
	// Table holds the table name of the voucherauditlog in the database.
	Table = "voucher_audit_logs"
)

// Columns holds all SQL columns for voucherauditlog fields.
var Columns = []string{
	FieldID,
	FieldOrderID,
	FieldB2bOrderID,
...
// OrderOption defines the ordering options for the VoucherAuditLog queries.
