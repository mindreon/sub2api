...
type UserEdges struct {
	...
	// VoucherOrders holds the value of the voucher_orders edge.
	VoucherOrders []*VoucherOrder `json:"voucher_orders,omitempty"`
...
// VoucherOrdersOrErr returns the VoucherOrders value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) VoucherOrdersOrErr() ([]*VoucherOrder, error) {
	if e.loadedTypes[10] {
		return e.VoucherOrders, nil
	}
	return nil, &NotLoadedError{edge: "voucher_orders"}
}
...
// QueryVoucherOrders queries the "voucher_orders" edge of the User entity.
func (_m *User) QueryVoucherOrders() *VoucherOrderQuery {
	return NewUserClient(_m.config).QueryVoucherOrders(_m)
}
