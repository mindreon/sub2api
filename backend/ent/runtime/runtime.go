...
func init() {
	...
	groupDescAllowMediaGeneration := groupFields[29].Descriptor()
	...
	groupDescMediaRateIndependent := groupFields[30].Descriptor()
	...
	groupDescMediaRateMultiplier := groupFields[31].Descriptor()
