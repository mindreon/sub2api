...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.BatchImageJob, c.CatalogModel, c.ChannelMonitor, c.ChannelMonitorDailyRollup,
		c.ChannelMonitorHistory, c.ChannelMonitorRequestTemplate,
		c.ErrorPassthroughRule, c.Group, c.IdempotencyRecord,
		c.IdentityAdoptionDecision, c.MediaGenerationTask, c.MediaQuotaHold,
...
type (
	hooks struct {
		...
		CatalogModel, ChannelMonitor, ChannelMonitorDailyRollup, ChannelMonitorHistory,
		ChannelMonitorRequestTemplate, ErrorPassthroughRule, Group, IdempotencyRecord,
		IdentityAdoptionDecision, MediaGenerationTask, MediaQuotaHold, PaymentAuditLog,
