export default {
  ...
  nav: {
    ...
    voucherManagement: 'PIN Vouchers',
    voucherReplenishment: 'Replenishment',
    voucherRetailOrders: 'Retail Orders',
    voucherSettings: 'KVoucher Settings',
    settings: 'Settings',
  ...
  videoGeneration: {
    ...
    description: 'Submit async video generation tasks (Seedance, etc.) with your API key and poll status automatically.',
    apiKey: 'API Key',
    apiKeyPlaceholder: 'sk-...',
    apiKeyHint: 'Copy the full key from API Keys. Gateway auth matches /v1/messages.',
    model: 'Model',
    useModel: 'Use model',
    ...
    referenceAudio: 'Reference audio URL',
    prompt: 'Prompt',
  ...
  admin: {
    ...
    groups: {
      ...
      mediaPricing: {
        title: 'Multimodal async generation billing',
        description: 'Configure /v1/video/generations async video generation and rate multipliers; bind platform accounts to this group.',
        allowMediaGeneration: 'Allow multimodal async generation for this group',
        independentMultiplier: 'Independent media rate multiplier',
        mediaMultiplier: 'Media rate multiplier',
        modeHint: 'When independent multiplier is off, cost = upstream cost × group effective rate; when on, uses the media-specific multiplier.'
      },
      modelsList: {
