export default {
  ...
  videoGeneration: {
    title: '视频生成',
    description: '使用 API Key 提交 Seedance 等模型的异步视频生成任务，并自动轮询状态。',
    apiKey: 'API Key',
    apiKeyPlaceholder: 'sk-...',
    apiKeyHint: '从「API 密钥」页面复制完整 Key；网关鉴权与 /v1/messages 相同。',
    model: '模型',
    useModel: '使用模型',
    resolution: '分辨率',
    ratio: '画幅比例',
    ...
    referenceVideo: '参考视频 URL',
    referenceAudio: '参考音频 URL',
    prompt: '提示词',
    promptPlaceholder: '描述你想生成的视频画面...',
    submit: '提交生成任务',
    submitting: '提交中...',
    submitted: '任务已提交',
    submitFailed: '提交失败',
