export default {
  ...
  nav: {
    ...
    ops: '运维监控',
    promoCodes: '优惠码',
    voucherManagement: '卡密管理',
    voucherReplenishment: '补货与库存',
    voucherRetailOrders: '零售订单',
    voucherSettings: 'KVoucher 设置',
    settings: '系统设置',
    myAccount: '我的账户',
    lightMode: '浅色模式',
    darkMode: '深色模式',
  ...
  admin: {
    ...
    groups: {
      ...
      mediaPricing: {
        title: '多模态异步生成计费',
        description: '配置 /v1/video/generations 等异步视频生成能力与倍率；需在本分组绑定对应平台账号。',
        allowMediaGeneration: '允许当前分组调用多模态异步生成',
        independentMultiplier: '多模态倍率独立',
        mediaMultiplier: '多模态独立倍率',
        modeHint: '默认关闭独立倍率时，费用 = 上游成本 × 当前分组有效倍率；开启后使用多模态独立倍率。'
      },
      modelsList: {
